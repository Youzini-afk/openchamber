export const settingsDict = {
  ...
  'settings.smartSearch.status.installHint': 'Install with npm install -g @konbakuyomu/smart-search, set SMART_SEARCH_BIN, or keep a sibling ../smartsearch checkout with its Python dependencies installed.',
