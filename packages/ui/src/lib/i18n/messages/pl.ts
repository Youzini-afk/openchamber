...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.pendingChanges.summary.modified': 'Zmodyfikowano {count}',
  'chat.pendingChanges.summary.created': 'Utworzono {count}',
  'chat.pendingChanges.summary.deleted': 'Usunięto {count}',
  'chat.changedFiles.title': 'Zmienione pliki',
  'chat.changedFiles.actions.openFile': 'Otwórz plik',
  'chat.changedFiles.actions.openFileTitle': 'Otwórz {path}',
  'chat.changedFiles.actions.viewDiff': 'Pokaż diff',
  'chat.changedFiles.actions.viewDiffTitle': 'Pokaż diff dla {path}',
  'chat.changedFiles.actions.revertFile': 'Cofnij zmiany',
  'chat.changedFiles.actions.revertFileTitle': 'Cofnij {path}',
  ...
  'chat.statusRow.todo.clear': 'Wyczyść',
  'chat.statusRow.todo.clearAria': 'Wyczyść zadania dla tej sesji',
  ...
  'gitView.changes.collapseDirectoryAria': 'Zwiń katalog {path}',
  'gitView.changes.expandDirectoryAria': 'Rozwiń katalog {path}',
  'gitView.changes.revertAll': 'Cofnij wszystko',
  'gitView.changes.revertAllDescriptionPlural': 'Cofnąć zmiany w {count} plikach? Tej operacji nie można cofnąć.',
  'gitView.changes.revertAllDescriptionSingle': 'Cofnąć zmiany w {count} pliku? Tej operacji nie można cofnąć.',
  ...
  'gitView.changes.revertFileAria': 'Cofnij zmiany w {path}',
  ...
  'gitView.changes.selectFileAria': 'Zaznacz {path}',
  ...
  'gitView.changes.toggleDirectorySelectionAria': 'Przełącz zaznaczenie katalogu {path}',
  ...
  'gitView.integrate.commitsMovedDescriptionPlural': 'Przeniesiono {count} commity do {branch}.',
  'gitView.integrate.commitsMovedDescriptionSingle': 'Przeniesiono {count} commit do {branch}.',
  ...
  'gitView.stash.description': 'Odłóż lokalne zmiany przed rozpoczęciem operacji {operation}.',
  'gitView.stash.mergeWith': 'Scal z',
  'gitView.stash.rebaseOnto': 'Wykonaj rebase na',
  'gitView.stash.restoreAfterOperation': 'Przywróć odłożone zmiany po operacji {operation}',
  ...
  'gitView.directorySelector.label': 'Folder Git',
  'gitView.directorySelector.noDirectory': 'Nie wybrano folderu',
  'gitView.directorySelector.choose': 'Wybierz folder',
  'gitView.directorySelector.followSession': 'Śledź sesję',
  'gitView.directorySelector.dialogTitle': 'Wybierz folder Git',
  'gitView.directorySelector.dialogDescription': 'Najpierw wybierz folder, a panel Git załaduje stan repozytorium dla tego folderu.',
  'gitView.directorySelector.dialogConfirm': 'Użyj folderu',
  'directoryExplorerDialog.actions.selectFolder': 'Wybierz folder',
  'directoryExplorerDialog.footer.confirm': 'Potwierdź',
  'directoryExplorerDialog.footer.close': 'Zamknij',
  'header.services.tokenUsage.title': 'Użycie tokenów',
  'header.services.tokenUsage.description': 'Liczby tokenów z ostatniej odpowiedzi asystenta.',
  'header.services.tokenUsage.total': 'Razem',
  'header.services.tokenUsage.input': 'Wejście',
  'header.services.tokenUsage.cache': 'Cache',
  'header.services.tokenUsage.output': 'Wyjście',
  'header.services.tokenUsage.reasoning': 'Rozumowanie',
  'header.services.tokenUsage.cacheBreakdown': 'Cache odczyt {read} · zapis {write}',
  'workspace.sidebar.title': 'Obszar roboczy',
  'workspace.sidebar.actions.terminal': 'Terminal',
  'workspace.sidebar.actions.newFolder': 'Nowy folder',
  'workspace.sidebar.actions.upload': 'Prześlij',
  'workspace.sidebar.actions.sort': 'Sort',
  'workspace.sidebar.actions.refresh': 'Odśwież',
  ...
  'workspace.sidebar.menu.aria': 'Menu obszaru roboczego',
  'workspace.sidebar.menu.openChat': 'Otwórz czat',
  'workspace.sidebar.menu.openFiles': 'Otwórz pliki',
  'workspace.sidebar.menu.openFile': 'Otwórz plik',
  'workspace.sidebar.menu.git': 'Git',
  'workspace.sidebar.menu.terminal': 'Terminal',
  'workspace.sidebar.menu.newFolder': 'Nowy folder',
  'workspace.sidebar.menu.newFile': 'Nowy plik',
  'workspace.sidebar.menu.upload': 'Prześlij',
  'workspace.sidebar.menu.refreshGitStatus': 'Odśwież status Git',
  'workspace.sidebar.menu.addToSession': 'Dodaj do sesji',
  'workspace.sidebar.menu.copyPath': 'Kopiuj ścieżkę',
  'workspace.sidebar.menu.rename': 'Zmień nazwę',
  'workspace.sidebar.menu.moveToTrash': 'Przenieś do kosza',
  'workspace.sidebar.menu.permanentDelete': 'Usuń trwale',
  'workspace.sidebar.trash.title': 'Kosz',
  'workspace.sidebar.trash.empty': 'Kosz jest pusty',
  'workspace.sidebar.state.empty': 'Pusto',
  'workspace.sidebar.state.loading': 'Ładowanie...',
  'workspace.sidebar.prompt.newFolderName': 'Nazwa nowego folderu',
  'workspace.sidebar.prompt.newFileName': 'Nazwa nowego pliku',
  'workspace.sidebar.prompt.renameTo': 'Zmień nazwę na',
  'workspace.sidebar.dialog.rename.title': 'Zmień nazwę',
  'workspace.sidebar.dialog.rename.description': 'Wprowadź nową nazwę dla „{name}”.',
  'workspace.sidebar.dialog.rename.placeholder': 'Nowa nazwa',
  'workspace.sidebar.dialog.rename.invalidName': 'Użyj nazwy bez ukośników.',
  'workspace.sidebar.dialog.rename.sameName': 'Wprowadź inną nazwę.',
  'workspace.sidebar.dialog.rename.cancel': 'Anuluj',
  'workspace.sidebar.dialog.rename.submit': 'Zmień nazwę',
  'workspace.sidebar.confirm.moveToTrash': 'Przenieść „{name}” do kosza?',
  'workspace.sidebar.confirm.permanentDelete': 'Trwale usunąć „{name}”? Tego nie można cofnąć.',
  'workspace.sidebar.toast.folderCreated': 'Folder utworzony',
  'workspace.sidebar.toast.fileCreated': 'Plik utworzony',
  'workspace.sidebar.toast.renamed': 'Zmieniono nazwę',
  'workspace.sidebar.toast.movedToTrash': 'Przeniesiono do kosza',
  'workspace.sidebar.toast.permanentlyDeleted': 'Usunięto trwale',
  'workspace.sidebar.toast.uploaded': 'Przesłano {count}',
  'workspace.sidebar.toast.uploadFailed': 'Przesyłanie nie powiodło się',
  'workspace.sidebar.toast.addedToSession': 'Dodano „{name}” do sesji',
  'workspace.sidebar.toast.pathCopied': 'Ścieżka skopiowana',
  'workspace.sidebar.toast.copyFailed': 'Kopiowanie nie powiodło się',
  'workspace.archive.menu.preview': 'Podgląd archiwum',
  'workspace.archive.menu.extractNewFolder': 'Wypakuj do nowego folderu',
  'workspace.archive.menu.extractHere': 'Wypakuj tutaj',
  'workspace.archive.actions.extract': 'Wypakuj',
  'workspace.archive.actions.extracting': 'Wypakowywanie...',
  'workspace.archive.actions.cancel': 'Anuluj',
  'workspace.archive.dialog.title': 'Archiwum',
  'workspace.archive.dialog.description': 'Podejrzyj i wypakuj zawartość archiwum.',
  'workspace.archive.dialog.format': 'Format',
  'workspace.archive.dialog.entries': 'Wpisy',
  'workspace.archive.dialog.entryCount': '{files} plików, {folders} folderów',
  'workspace.archive.dialog.totalSize': 'Łączny rozmiar',
  'workspace.archive.dialog.mode': 'Tryb',
  'workspace.archive.dialog.conflict': 'Konflikty',
  'workspace.archive.dialog.destination': 'Miejsce docelowe',
  'workspace.archive.dialog.destinationPlaceholder': 'miejsce docelowe względem obszaru roboczego',
  'workspace.archive.dialog.deleteArchive': 'Usuń archiwum po pomyślnym wypakowaniu',
  'workspace.archive.dialog.loading': 'Odczytywanie archiwum...',
  'workspace.archive.dialog.folder': 'folder',
  'workspace.archive.dialog.truncated': 'Podgląd obcięty.',
  'workspace.archive.dialog.empty': 'Brak wpisów',
  'workspace.archive.mode.newFolder': 'Nowy folder',
  'workspace.archive.mode.merge': 'Wypakuj tutaj',
  'workspace.archive.conflict.rename': 'Automatycznie zmień nazwę',
  'workspace.archive.conflict.skip': 'Pomiń istniejące',
  'workspace.archive.conflict.error': 'Zatrzymaj przy konflikcie',
  'workspace.archive.toast.previewFailed': 'Nie udało się podejrzeć archiwum',
  'workspace.archive.toast.extracted': 'Wypakowano {files} plików i {folders} folderów',
  'workspace.terminal.actions.restart': 'Uruchom ponownie',
  'workspace.terminal.actions.stop': 'Zatrzymaj',
  'workspace.terminal.actions.restore': 'Przywróć',
  'workspace.terminal.actions.maximize': 'Maksymalizuj',
  'workspace.terminal.actions.hide': 'Ukryj',
  'workspace.terminal.status.connecting': 'Łączenie...',
  'workspace.terminal.status.processExited': 'proces zakończony',
  'workspace.terminal.error.createFailed': 'Nie udało się utworzyć terminala',
  'workspace.terminal.error.connectionFailed': 'Połączenie terminala nie powiodło się',
  'workspace.terminal.error.sendFailed': 'Nie udało się wysłać wejścia',
  'workspace.git.title': 'Git - {path}',
  'workspace.git.workspace': 'obszar roboczy',
  'workspace.git.description': 'repozytorium obszaru roboczego',
  'workspace.git.state.loading': 'Ładowanie...',
  'workspace.git.state.notRepository': 'To nie jest repozytorium Git',
  'workspace.git.state.notRepositoryHint': 'Sklonuj repozytorium do tego folderu albo otwórz tu terminal, aby wykonać git init i inne polecenia.',
  'workspace.git.state.clean': 'Czysto',
  'workspace.git.state.none': 'Brak',
  'workspace.git.actions.terminal': 'Terminal',
  'workspace.git.actions.refresh': 'Odśwież',
  'workspace.git.actions.fetch': 'Fetch',
  'workspace.git.actions.clone': 'Klonuj',
  'workspace.git.actions.pull': 'Pull',
  'workspace.git.actions.push': 'Push',
  'workspace.git.actions.checkout': 'Checkout',
  'workspace.git.actions.stageAll': 'Dodaj wszystkie zmiany do stagingu',
  'workspace.git.actions.selectFile': 'Wybierz {path}',
  'workspace.git.actions.commit': 'Commit',
  'workspace.git.actions.close': 'Zamknij',
  'workspace.git.summary.branch': 'Gałąź',
  'workspace.git.summary.remote': 'Zdalne',
  'workspace.git.summary.ahead': 'Do przodu',
  'workspace.git.summary.behind': 'W tyle',
  'workspace.git.section.clone': 'Sklonuj repozytorium',
  'workspace.git.section.repository': 'Bieżące repozytorium',
  'workspace.git.section.checkout': 'Checkout',
  'workspace.git.section.changes': 'Zmiany',
  'workspace.git.section.remotes': 'Zdalne',
  'workspace.git.section.recentLog': 'Ostatni log',
  'workspace.git.clone.description': 'Uruchamia się w {path}. Użyj URL repozytorium HTTPS lub SSH.',
  'workspace.git.placeholder.repositoryUrl': 'URL repozytorium',
  'workspace.git.placeholder.cloneBranch': 'gałąź opcjonalna',
  'workspace.git.placeholder.cloneDirectory': 'folder opcjonalny',
  'workspace.git.placeholder.branch': 'gałąź',
  'workspace.git.placeholder.commitMessage': 'wiadomość commita',
  'workspace.git.toast.cloned': 'Repozytorium sklonowane',
  'workspace.git.toast.fetched': 'Pobrano',
  'workspace.git.toast.pulled': 'Pobrano pull',
  'workspace.git.toast.pushed': 'Wypchnięto',
  'workspace.git.toast.checkedOut': 'Przełączono',
  'workspace.git.toast.selectFiles': 'Wybierz pliki lub dodaj wszystkie zmiany do stagingu',
  'workspace.git.toast.committed': 'Commit utworzony',
