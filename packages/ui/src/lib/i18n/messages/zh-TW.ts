...
export const dict = {
  ...
  'chat.toolPart.input': '輸入',
  'chat.toolPart.output': '輸出',
  'chat.toolPart.metadata': '中繼資料',
  'chat.toolPart.details': '工具詳情',
  ...
  'gitView.directorySelector.label': 'Git 資料夾',
  'gitView.directorySelector.noDirectory': '未選擇資料夾',
  'gitView.directorySelector.choose': '選擇資料夾',
  'gitView.directorySelector.followSession': '跟隨會話',
  'gitView.directorySelector.dialogTitle': '選擇 Git 資料夾',
  'gitView.directorySelector.dialogDescription': '請先選擇資料夾，Git 面板會載入該資料夾的儲存庫狀態。',
  'gitView.directorySelector.dialogConfirm': '使用資料夾',
  'chat.pendingChanges.summary.modified': '已修改 {count}',
  'chat.pendingChanges.summary.created': '已建立 {count}',
  'chat.pendingChanges.summary.deleted': '已刪除 {count}',
  'chat.changedFiles.actions.openFile': '開啟檔案',
  'chat.changedFiles.actions.viewDiff': '檢視 diff',
  'chat.changedFiles.actions.viewDiffTitle': '檢視 {path} 的 diff',
  'chat.changedFiles.actions.revertFile': '還原變更',
  'chat.changedFiles.actions.revertFileTitle': '還原 {path}',
  'chat.checkpoint.label.beforeMessage': '訊息之前',
  'chat.checkpoint.confirm.viewDiff': '此訊息有檔案 checkpoint。還原前要先開啟第一個變更檔案的 diff 嗎？（{count} 個變更）',
  'chat.checkpoint.confirm.restore': '要將工作區檔案還原到此訊息 checkpoint 嗎？這可能會覆寫或刪除目前的工作區變更。將先建立安全 checkpoint。（影響或追蹤 {count} 個檔案）',
  'chat.checkpoint.alert.restoreFailed': '還原 checkpoint 失敗：{message}',
  'chat.statusRow.todo.clear': '清除',
  'chat.statusRow.todo.clearAria': '清除此會話的任務',
  'directoryExplorerDialog.actions.selectFolder': '選擇資料夾',
  'directoryExplorerDialog.footer.confirm': '確認',
  'directoryExplorerDialog.footer.close': '關閉',
  'header.services.tokenUsage.title': 'Token 用量',
  'header.services.tokenUsage.description': '最近一次助理回覆的 token 數。',
  ...
  'workspace.sidebar.title': '工作區',
  'workspace.sidebar.actions.terminal': '終端機',
  'workspace.sidebar.actions.newFolder': '新增資料夾',
  'workspace.sidebar.actions.upload': '上傳',
  'workspace.sidebar.actions.sort': '排序',
  'workspace.sidebar.actions.refresh': '重新整理',
  'workspace.sidebar.sort.nameAsc': '名稱 A → Z',
  'workspace.sidebar.sort.nameDesc': '名稱 Z → A',
  'workspace.sidebar.sort.modifiedDesc': '最近修改優先',
  'workspace.sidebar.sort.modifiedAsc': '最早修改優先',
  'workspace.sidebar.menu.aria': '工作區選單',
  'workspace.sidebar.menu.openChat': '開啟聊天',
  'workspace.sidebar.menu.openFiles': '開啟檔案',
  'workspace.sidebar.menu.openFile': '開啟檔案',
  'workspace.sidebar.menu.git': 'Git',
  'workspace.sidebar.menu.terminal': '終端機',
  'workspace.sidebar.menu.newFolder': '新增資料夾',
  'workspace.sidebar.menu.newFile': '新增檔案',
  'workspace.sidebar.menu.upload': '上傳',
  'workspace.sidebar.menu.refreshGitStatus': '重新整理 Git 狀態',
  'workspace.sidebar.menu.addToSession': '新增到會話',
  'workspace.sidebar.menu.copyPath': '複製路徑',
  'workspace.sidebar.menu.rename': '重新命名',
  'workspace.sidebar.menu.moveToTrash': '移到垃圾桶',
  'workspace.sidebar.menu.permanentDelete': '永久刪除',
  'workspace.sidebar.trash.title': '垃圾桶',
  'workspace.sidebar.trash.empty': '垃圾桶是空的',
  'workspace.sidebar.state.empty': '空',
  'workspace.sidebar.state.loading': '載入中...',
  'workspace.sidebar.prompt.newFolderName': '新資料夾名稱',
  'workspace.sidebar.prompt.newFileName': '新檔案名稱',
  'workspace.sidebar.prompt.renameTo': '重新命名為',
  'workspace.sidebar.dialog.rename.title': '重新命名',
  'workspace.sidebar.dialog.rename.description': '為「{name}」輸入新名稱。',
  'workspace.sidebar.dialog.rename.placeholder': '新名稱',
  'workspace.sidebar.dialog.rename.invalidName': '請使用不含斜線的名稱。',
  'workspace.sidebar.dialog.rename.sameName': '請輸入不同名稱。',
  'workspace.sidebar.dialog.rename.cancel': '取消',
  'workspace.sidebar.dialog.rename.submit': '重新命名',
  'workspace.sidebar.confirm.moveToTrash': '將「{name}」移到垃圾桶？',
  'workspace.sidebar.confirm.permanentDelete': '永久刪除「{name}」？此操作無法復原。',
  'workspace.sidebar.toast.folderCreated': '資料夾已建立',
  'workspace.sidebar.toast.fileCreated': '檔案已建立',
  'workspace.sidebar.toast.renamed': '已重新命名',
  'workspace.sidebar.toast.movedToTrash': '已移到垃圾桶',
  'workspace.sidebar.toast.permanentlyDeleted': '已永久刪除',
  'workspace.sidebar.toast.uploaded': '已上傳 {count}',
  'workspace.sidebar.toast.uploadFailed': '上傳失敗',
  'workspace.sidebar.toast.addedToSession': '已將「{name}」新增到會話',
  'workspace.sidebar.toast.pathCopied': '路徑已複製',
  'workspace.sidebar.toast.copyFailed': '複製失敗',
  'workspace.archive.menu.preview': '預覽壓縮檔',
  'workspace.archive.menu.extractNewFolder': '解壓縮到新資料夾',
  'workspace.archive.menu.extractHere': '解壓縮到此處',
  'workspace.archive.actions.extract': '解壓縮',
  'workspace.archive.actions.extracting': '解壓縮中...',
  'workspace.archive.actions.cancel': '取消',
  'workspace.archive.dialog.title': '壓縮檔',
  'workspace.archive.dialog.description': '預覽並解壓縮壓縮檔內容。',
  'workspace.archive.dialog.format': '格式',
  'workspace.archive.dialog.entries': '項目',
  'workspace.archive.dialog.entryCount': '{files} 個檔案，{folders} 個資料夾',
  'workspace.archive.dialog.totalSize': '總大小',
  'workspace.archive.dialog.mode': '模式',
  'workspace.archive.dialog.conflict': '衝突',
  'workspace.archive.dialog.destination': '目的地',
  'workspace.archive.dialog.destinationPlaceholder': '工作區相對目的地',
  'workspace.archive.dialog.deleteArchive': '成功解壓縮後刪除壓縮檔',
  'workspace.archive.dialog.loading': '正在讀取壓縮檔...',
  'workspace.archive.dialog.folder': '資料夾',
  'workspace.archive.dialog.truncated': '預覽已截斷。',
  'workspace.archive.dialog.empty': '沒有項目',
  'workspace.archive.mode.newFolder': '新資料夾',
  'workspace.archive.mode.merge': '解壓縮到此處',
  'workspace.archive.conflict.rename': '自動重新命名',
  'workspace.archive.conflict.skip': '略過現有項目',
  'workspace.archive.conflict.error': '衝突時停止',
  'workspace.archive.toast.previewFailed': '預覽壓縮檔失敗',
  'workspace.archive.toast.extracted': '已解壓縮 {files} 個檔案和 {folders} 個資料夾',
  'workspace.terminal.actions.restart': '重新啟動',
  'workspace.terminal.actions.stop': '停止',
  'workspace.terminal.actions.restore': '還原',
  'workspace.terminal.actions.maximize': '最大化',
  'workspace.terminal.actions.hide': '隱藏',
  'workspace.terminal.status.connecting': '連線中...',
  'workspace.terminal.status.processExited': '程序已結束',
  'workspace.terminal.error.createFailed': '建立終端機失敗',
  'workspace.terminal.error.connectionFailed': '終端機連線失敗',
  'workspace.terminal.error.sendFailed': '傳送輸入失敗',
  'workspace.git.title': 'Git - {path}',
  'workspace.git.workspace': '工作區',
  'workspace.git.description': '工作區儲存庫',
  'workspace.git.state.loading': '載入中...',
  'workspace.git.state.notRepository': '不是 Git 儲存庫',
  'workspace.git.state.notRepositoryHint': '將儲存庫複製到此資料夾，或在此開啟終端機執行 git init 和其他命令。',
  'workspace.git.state.clean': '乾淨',
  'workspace.git.state.none': '無',
  'workspace.git.actions.terminal': '終端機',
  'workspace.git.actions.refresh': '重新整理',
  ...
  'workspace.git.actions.stageAll': '暫存所有變更',
  'workspace.git.actions.selectFile': '選擇 {path}',
  'workspace.git.actions.commit': 'Commit',
  'workspace.git.actions.close': '關閉',
  'workspace.git.summary.branch': '分支',
  'workspace.git.summary.remote': '遠端',
  'workspace.git.summary.ahead': '領先',
  'workspace.git.summary.behind': '落後',
  'workspace.git.section.clone': 'Clone Repository',
  'workspace.git.section.repository': '目前儲存庫',
  'workspace.git.section.checkout': 'Checkout',
  'workspace.git.section.changes': '變更',
  'workspace.git.section.remotes': '遠端',
  'workspace.git.section.recentLog': '最近記錄',
  'workspace.git.clone.description': '在 {path} 中執行。請使用 HTTPS 或 SSH 儲存庫 URL。',
  'workspace.git.placeholder.repositoryUrl': '儲存庫 URL',
  'workspace.git.placeholder.cloneBranch': '分支（可選）',
  'workspace.git.placeholder.cloneDirectory': '資料夾（可選）',
  'workspace.git.placeholder.branch': '分支',
  'workspace.git.placeholder.commitMessage': 'commit 訊息',
  'workspace.git.toast.cloned': '儲存庫已 clone',
  'workspace.git.toast.fetched': '已 fetch',
  'workspace.git.toast.pulled': '已 pull',
  'workspace.git.toast.pushed': '已 push',
  'workspace.git.toast.checkedOut': '已 checkout',
  'workspace.git.toast.selectFiles': '選擇檔案或暫存所有變更',
  'workspace.git.toast.committed': '已 commit',
};
