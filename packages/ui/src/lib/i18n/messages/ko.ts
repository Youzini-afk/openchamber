...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.changes.collapseDirectoryAria': '{path} 디렉터리 접기',
  'gitView.changes.expandDirectoryAria': '{path} 디렉터리 펼치기',
  ...
  'gitView.changes.toggleDirectorySelectionAria': '{path} 선택 전환',
  ...
  'gitView.conflict.abortOperation': '{operation} 중단',
  'gitView.conflict.conflictedFiles': '충돌한 파일:',
  'gitView.conflict.continueLater': '나중에 계속',
  'gitView.conflict.detectedDescription': '{operation} 충돌을 해결한 뒤 계속하세요.',
  'gitView.conflict.detectedTitle': '{operation} 충돌 발견됨',
  'gitView.conflict.errorLoadingDetails': '상세 정보 로드 오류: {message}',
  ...
  'gitView.header.removeRemoteAria': '{name} 리모트 제거',
  'gitView.header.removeRemoteTitle': '{name} 리모트 제거',
  ...
  'gitView.integrate.commitsMovedDescriptionPlural': '커밋 {count}개를 {branch}(으)로 이동했습니다.',
  'gitView.integrate.commitsMovedDescriptionSingle': '커밋 {count}개를 {branch}(으)로 이동했습니다.',
  ...
  'gitView.stash.description': '{operation}을(를) 시작하기 전에 로컬 변경 사항을 stash하세요.',
  'gitView.stash.mergeWith': '다음과 병합',
  'gitView.stash.rebaseOnto': '다음 위로 리베이스',
  'gitView.stash.restoreAfterOperation': '{operation} 후 stash한 변경 사항 복원',
  ...
  'workspace.sidebar.menu.permanentDelete': '영구 삭제',
  'workspace.sidebar.trash.title': '휴지통',
  'workspace.sidebar.trash.empty': '휴지통이 비어 있습니다',
  ...
  'workspace.sidebar.dialog.rename.title': '이름 변경',
  'workspace.sidebar.dialog.rename.description': '"{name}"의 새 이름을 입력하세요.',
  'workspace.sidebar.dialog.rename.placeholder': '새 이름',
  'workspace.sidebar.dialog.rename.invalidName': '슬래시가 없는 이름을 사용하세요.',
  'workspace.sidebar.dialog.rename.sameName': '다른 이름을 입력하세요.',
  'workspace.sidebar.dialog.rename.cancel': '취소',
  'workspace.sidebar.dialog.rename.submit': '이름 변경',
  'workspace.sidebar.confirm.moveToTrash': 'Move "{name}" to trash?',
  'workspace.sidebar.confirm.permanentDelete': '"{name}"을(를) 영구 삭제할까요? 이 작업은 되돌릴 수 없습니다.',
  ...
  'workspace.sidebar.toast.permanentlyDeleted': '영구 삭제됨',
  ...
  'chat.pendingChanges.summary.modified': '수정 {count}',
  'chat.pendingChanges.summary.created': '생성 {count}',
  'chat.pendingChanges.summary.deleted': '삭제 {count}',
  'chat.changedFiles.title': '변경된 파일',
  'chat.changedFiles.actions.openFile': '파일 열기',
  'chat.changedFiles.actions.openFileTitle': '{path} 열기',
  'chat.changedFiles.actions.viewDiff': 'Diff 보기',
  'chat.changedFiles.actions.viewDiffTitle': '{path} diff 보기',
  'chat.changedFiles.actions.revertFile': '변경 사항 되돌리기',
  'chat.changedFiles.actions.revertFileTitle': '{path} 되돌리기',
